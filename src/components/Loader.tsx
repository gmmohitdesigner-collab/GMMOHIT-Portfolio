...
export default function Loader({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 z-[9999] pointer-events-auto bg-[#000000] font-sans text-white flex justify-between p-6 sm:p-8 md:p-12 overflow-hidden"
    >
      {/* Top Left Branding */}
      <div className="flex flex-col text-[10px] sm:text-xs md:text-sm tracking-widest font-medium leading-relaxed uppercase">
      ...
      <div 
        className="flex items-start text-white text-5xl sm:text-7xl md:text-[8vw] font-medium tracking-tighter"
