...
export default function ServicesSection() {
    ...
    // On mobile, we don't translate horizontally (we'll just stack them vertically)
    const x = useTransform(scrollYProgress, [0, 1], ["0%", isMobile ? "0%" : "-75%"]);
    
    // Progress bar width (must be called before early return to avoid React hook errors)
    ...
    if (isMobile) {
        ...
        return (
            <section className="w-full flex flex-col bg-[#3F352C] text-[#E8E3DA] py-24 px-4 gap-24">
                {/* Slide 1 Mobile Equivalent */}
                <div className="flex flex-col gap-12 min-h-[80vh] justify-center relative">
                    <p className="font-circular text-xl md:text-2xl leading-tight max-w-sm">
                        Most designers make things look good. I make things feel inevitable — where every pixel has a reason.
                    </p>
                    <div className="w-full flex justify-center py-16 opacity-80 mix-blend-screen text-[#E8E3DA]">
                        <AsciiTorus />
                    </div>
                    <div className="flex flex-col gap-4">
                        ...
                        <h2 className="font-monument text-5xl text-[#E8E3DA] tracking-tighter uppercase leading-[0.8]">
                            Services@26
                        </h2>
                    </div>
                </div>
    ...
    return (
        <section 
            ref={targetRef} 
            className="w-full relative h-[400vh] bg-[#3F352C] text-[#E8E3DA]" 
            id="services"
        >
            <div className="sticky top-0 h-screen overflow-hidden flex items-center">
                ...
                >
                    ...
                    <div className="w-screen h-full flex flex-col relative px-12 lg:px-24 py-16">
                        ...
                        {/* Center Graphic */}
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] flex items-center justify-center opacity-90 text-[#E8E3DA] mix-blend-screen pointer-events-none">
                            <AsciiTorus />
                        </div>
