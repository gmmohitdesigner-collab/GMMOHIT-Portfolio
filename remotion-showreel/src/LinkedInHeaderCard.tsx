...
export const LinkedInHeaderCard: React.FC = () => {
  return (
    <div
      style={{
        width: 1584,
    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...
            height: "34px",
            borderRadius: "50%",
            border: "1.5px solid rgba(63, 53, 44, 0.35)",
            display: "flex",
            alignItems: "center",
      ...
      >
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#3F352C" strokeWidth="1.5" style={{ opacity: 0.6 }}>
